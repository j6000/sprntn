...
.super-navbar__theme-toggle {
    transition: background 0.16s ease-in-out, border 0.16s ease-in-out !important;
}
...
:root {
    --select-highlight-color: rgba(253, 215, 99, 0.4);
    --color-checkbox-bg: #888888 !important;
    --header-title-opacity: 0.5 !important;
...
.theme-dark {
    ...
    --card-content-bg-color: rgba(0, 0, 0, 0.6) !important;
    --color-border-default: rgba(255, 255, 255, 0.12) !important;
    --navbar-background-color: rgba(25, 25, 25, 0.8) !important;
    --color-code-bg: var(--color-bg-gray-light) !important;
    --color-ui-hover-bg: #202020 !important;
}
.theme-light {
    --card-content-bg-color: rgba(255, 255, 255, 0.6) !important;
    --color-border-default: rgba(204, 204, 204, 0.4) !important;
    --navbar-background-color: rgba(246, 246, 246, 0.8) !important;
